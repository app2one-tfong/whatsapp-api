...
class SendPTTRequest(ModelNormal):
    ...
    def __init__(self, chat_id=None, phone=None, audio=None):  # noqa: E501
        """SendPTTRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def chat_id(self):
        ...
        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501
        ...
        :return: The chat_id of this SendPTTRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def chat_id(self, chat_id):  # noqa: E501
        """Sets the chat_id of this SendPTTRequest.

        **Required if phone is not set**  Chat ID from the message list. Examples: 17633123456@c.us for private messages and 17680561234-1479621234@g.us for the group. Used instead of the phone parameter.  # noqa: E501

        :param chat_id: The chat_id of this SendPTTRequest.  # noqa: E501
        :type: str
        """
    ...
    def phone(self):
        ...
        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501
        ...
        :return: The phone of this SendPTTRequest.  # noqa: E501
        :rtype: int
        """
        return self._phone
    ...
    def phone(self, phone):  # noqa: E501
        """Sets the phone of this SendPTTRequest.

        **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.  # noqa: E501

        :param phone: The phone of this SendPTTRequest.  # noqa: E501
        :type: int
        """
    ...
    def audio(self):
        ...
        :return: The audio of this SendPTTRequest.  # noqa: E501
        :rtype: str
        """
        return self._audio

    @audio.setter
    def audio(self, audio):  # noqa: E501
        """Sets the audio of this SendPTTRequest.

        A link to an audio ogg-file in opus codec  Or base64 ogg-file in opus codec, for example *data:audio/ogg;base64,...*  # noqa: E501

        :param audio: The audio of this SendPTTRequest.  # noqa: E501
        :type: str
        """
        if audio is None:
            raise ApiValueError("Invalid value for `audio`, must not be `None`")  # noqa: E501
