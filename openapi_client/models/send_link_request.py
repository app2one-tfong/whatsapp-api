...
class SendLinkRequest(ModelNormal):
    ...
    def preview_base64(self, preview_base64):  # noqa: E501
        ...
        if preview_base64 is None:
            raise ApiValueError("Invalid value for `preview_base64`, must not be `None`")  # noqa: E501

        self._preview_base64 = (
            preview_base64
        )
    ...
    def title(self, title):  # noqa: E501
        ...
        """
        if title is None:
            raise ApiValueError("Invalid value for `title`, must not be `None`")  # noqa: E501
    ...
    @description.setter
    def description(self, description):  # noqa: E501
